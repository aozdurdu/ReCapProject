...
namespace Business.Concrete
{
    public class FakeCardManager : IFakeCardService
    {
        ...
        {
            return new SuccessDataResult<FakeCard>(_fakeCardDal.Get(c => c.CardId == id));
        }
        ...
        {
            var result = _fakeCardDal.Get(c => c.CardOwner == fakeCard.CardOwner && c.CardNumber == fakeCard.CardNumber && c.CardSecurityNumber == fakeCard.CardSecurityNumber);
            if (result == null)
            {
